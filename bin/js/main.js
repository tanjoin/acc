...
const card_1 = require("./view/card");
class Main {
    showContents(window) {
        let urlQuery = url_utils_1.default.getUrlQuery(window);
        if (urlQuery) {
        ...
        this._campaigns.sort(function (a, b) {
            if (!a.isShow()) {
                return -1;
            }
            if (!b.isShow()) {
    ...
    showCampaigns() {
        ...
        for (var i = 0; i < this._campaigns.length; i++) {
            var cardView = new card_1.default(this._campaigns[i]);
...
},{"./api/main_request":2,"./util/url_utils":7,"./view/card":8}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
